//const transferSteps = Array.from(document.querySelectorAll(".transfer-block__step"));
...
const exchangeSteps = document.querySelector(".exchange-steps");
...
if (exchangeLink) {
  ...
  /*  _exchange-link - "отправить",   _exchange-link-second - "обменять"  */
...
function nav(blocks, links, activeClass, secondClass = "") {
  if (links[0]) {
    ...
    function toggleActiveBlock() {
      ...
      /*     if (document.querySelector(".transfer-block__link").classList.contains("border_title")) {
